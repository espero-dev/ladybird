    ...
    , m_webdriver_content_ipc_path(webdriver_content_ipc_path)
{
    ...
    add_user_agent("Firefox MicroWave Desktop", "Mozilla/5.0 (MicroWave; Desktop; Transformer) Gecko/68.0 Firefox/86.0");
    ...
    add_user_agent("Firefox MicroWave Mobile", "Mozilla/5.0 (MicroWave; Mobile; Transformer) Gecko/68.0 Firefox/86.0");
